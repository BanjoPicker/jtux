...
bool field_jtoc_uid(JNIEnv *env, jclass cls, const char *field, jobject obj, uid_t * uid) {
	jfieldID fid;
...
bool field_jtoc_gid(JNIEnv *env, jclass cls, const char *field, jobject obj, gid_t * gid) {
	jfieldID fid;
