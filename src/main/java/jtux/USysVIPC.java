...
public class USysVIPC
{
    ...
    /**
     *         Java version of C struct msginfo.
     *                 <p>
     *                         <font size="-1"><b><i>Click {@link <a href="doc-files/synopses.html#struct_msginfo">here</a>} for Posix/SUS C API.</i></b></font>
     *                             */
    static public class s_msginfo
    {
    ...
    public native static void msgctl2(int msqid, int cmd, s_msginfo data) throws UErrorException;
