 ...
 */
JNIEXPORT void JNICALL Java_jtux_USysVIPC_msgctl(JNIEnv *, jclass, jint, jint, jobject);

/*
 * Class:     jtux_USysVIPC
 * Method:    msgctl
 * Signature: (IILjtux/USysVIPC$s_msginfo;)V
 */
JNIEXPORT void JNICALL Java_jtux_USysVIPC_msgctl2(JNIEnv *, jclass, jint, jint, jobject);
