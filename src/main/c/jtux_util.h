...
bool field_ctoj_object(JNIEnv *env, jclass cls, const char *field, const char *sig, jobject obj, jobject fobj);
bool field_ctoj_string(JNIEnv *env, jclass cls, const char *field, jobject obj, const char *s);
bool field_jtoc_long(JNIEnv *env, jclass cls, const char *field, jobject obj, long *n);
bool field_jtoc_uid(JNIEnv *env, jclass cls, const char *field, jobject obj, uid_t * n);
bool field_jtoc_gid(JNIEnv *env, jclass cls, const char *field, jobject obj, gid_t * n);
...
bool field_jtoc_bytearray(JNIEnv *env, jclass cls, const char *field, jobject obj, void **ptr, jbyteArray *ba);
...
bool field_jtoc_object(JNIEnv *env, jclass cls, const char *field, const char *sig, jobject obj, jobject *fobj);
bool field_jtoc_string(JNIEnv *env, jclass cls, const char *field, jobject obj, char *buf, size_t bufsize);
